...
def _execute(filters, additional_table_columns=None, additional_query_columns=None):
    ...
    for inv in invoice_list:
        ...
        customer_details = frappe.get_doc("Customer", inv.customer_name)
        ...
        if invoice_details.is_real_time == 1:
            is_realtime = "Yes"
...
def get_columns(invoice_list, additional_table_columns):
    ...
    columns = [
			...
			{
                    'label': _("Refrence Bill Date"),
                    'fieldname': 'ref_bill_date',
                    'fieldtype': 'Data',
                    'width': 120
            },
            {
                    'label': _("Refrence Bill No"),
			...
			{
                    'label': _("Printed Times"),
                    'fieldname': 'printed_times',
                    'fieldtype': 'Data',
                    'width': 100
            },
			{
                    'label': _("Printed Timestamp"),
                    'fieldname': 'printed_timestamp',
                    'fieldtype': 'Data',
                    'width': 120
            },
			{
