...
def execute(filters=None):
    ...
    for sle in sl_entries:
        ...
        balance_stock_value = flt(
            sle.qty_after_transaction * sle.valuation_rate)
...
def get_columns():
    columns = [
        {"label": _("Product Code"), "fieldname": "item_code",
         "fieldtype": "Link", "options": "Item", "width": 100},
        {"label": _("Product Description"),
         "fieldname": "description", "width": 130},
        {"label": _("UOM"), "fieldname": "stock_uom",
         "fieldtype": "Link", "options": "UOM", "width": 80},
        {"label": _("Opening Qty"), "fieldname": "opening_stock",
        ...
        {"label": _("Received Qty"), "fieldname": "recieved_qty",
         "fieldtype": "Float", "width": 100, "convertible": "qty"},
        {"label": _("Received Values"), "fieldname": "recieved_value", "fieldtype": "Currency", "width": 110,
         "options": "Company:company:default_currency", "convertible": "rate"},
        {"label": _("Delivered Qty"), "fieldname": "delivered_qty",
         "fieldtype": "Float", "width": 100, "convertible": "qty"},
        {"label": _("Delivered Values"), "fieldname": "delivered_value",
         "fieldtype": "Float", "width": 100, "convertible": "qty"},
        {"label": _("Balance Qty"), "fieldname": "qty_after_transaction",
         "fieldtype": "Float", "width": 100, "convertible": "qty"},
        {"label": _("Balance Rate"), "fieldname": "valuation_rate",
         "fieldtype": "Float", "width": 100, "convertible": "qty"},
